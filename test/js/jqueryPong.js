// http://benogle.com/2009/04/20/jquery-pong.html, the article this script is taken from
// modified slightly by joe kendall
//ZOMG! jQuery pong!! W00t, yeah.
//Based on the one by a guy named Ben White @ benwhite@columbus.rr.com
//jQuery'd by Ben Ogle. 
var megazineLetters = ['m','e','g','a','z','i','n','e', '!'];
var curMegaLetter = 0;
var megazineCover = function(){
  

  if(curMegaLetter === megazineLetters.length){
    curMegaLetter=0;
  }
  $('#marque').text(megazineLetters[curMegaLetter]);

  curMegaLetter++;

};

var resetMegazineCover = function(){
...
(function($){  
  $.fn.pong = function(ballImage, options) {
    ...
    var defaults = {
      ...
      ballSpeed: 10,     //pixels per update
      ...
      paddleWidth: 10,  //px
      paddleHeight: 40, //px
      paddleBuffer: 2,  //px from the edge of the play area
      ballWidth: 15,    //px
      ballHeight: 15,   //px
      playTo: 10        //points
    }
    ...
    return this.each(function() {
      ...
      $this.append('<div id="marque" style="height:100%;z-index:2; position:absolute;background:none;border:0;top:0; left:0; width:100%;height:100%;"></div>');
      $this.append('<textarea class="field" style="z-index:1; position:absolute;background:#000;border:0;top:-9999; left:-9999; width:0;height0;"></textarea>');
      ...
      $this.append('<div class="leftPaddle" style="z-index:3; position:absolute;background-color:#ffffff;"></div>');
      $this.append('<div class="rightPaddle" style="z-index:3; position:absolute;background-color:#ffffff;"></div>');
      $this.append('<img src="'+ballImage+'" class="ball" style="z-index:3; position:absolute;visibility:hidden;">');
      $this.append('<div class="msg" style="position:absolute; font-size: 9pt; color:#fff; bottom: -20px; right: 2px;"></div>');
      ...
      leftPaddle.css('left', opts.paddleBuffer+ 'px');
      ...
      rightPaddle.css('left', opts.width - opts.paddleWidth - opts.paddleBuffer + 'px');
